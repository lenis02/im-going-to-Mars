        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-[#1c1c1c] text-[#a3a3a3] text-xs uppercase tracking-wider">
              ...
              <th className="px-6 py-3 text-right font-medium">연속 순매수</th>
          ...
          <tbody className="divide-y divide-[#1c1c1c]">
            {loading && !data.length
              ...
              : data.map((item, idx) => (
                  ...
                  >
                    <td className="px-6 py-4 text-right font-mono text-[#a3a3a3]">
                      {idx + 1}
                    </td>
